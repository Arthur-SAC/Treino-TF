...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    difficulty: "iniciante",
    description: "AQUECIMENTO (5 min): resistência nível 2-3 de 8, cadência tranquila (~60 pedaladas por minuto). Você tem que conseguir conversar normalmente. Sentada com as costas apoiadas; ajusta o banco pra perna quase esticar no ponto mais longe, sem travar o joelho.",
    commonMistakes: [
  ...
  },
  {
    ...
    proTips: [
      ...
      "Escápula pra trás e pra baixo no topo: é costas bonita, não costas larga",
    ],
  },
  {
    id: "farmer-walk",
  ...
  },
  {
    ...
    harderVariation: "Mãos cruzadas no peito com uma anilha leve, pausa de 2 s em cima",
    exposureLevel: 2,
...
export const EXERCISE_VIDEOS: Record<string, string> = {
  ...
  // Chun-Li macia (2026-09-23) — escolhidos pelo título na busca do YouTube;
  // se algum não abrir ou mostrar outra coisa, ela troca pelo "editar".
  "leg-press-pes-medios": "https://www.youtube.com/watch?v=78mCZPObzug",
  "cadeira-extensora": "https://www.youtube.com/watch?v=mruTNzILY3U",
  "flexora-em-pe": "https://www.youtube.com/watch?v=T--10UN1jKs",
  "rosca-martelo": "https://www.youtube.com/watch?v=1-xCKLVxqqg",
  "rosca-barra-w": "https://www.youtube.com/watch?v=V6UEDzY51gY",
  "triceps-testa-barra-w": "https://www.youtube.com/watch?v=-zCw46DgI5M",
  "remada-unilateral-halter": "https://www.youtube.com/watch?v=WrF-rpwax4k",
  "farmer-walk": "https://www.youtube.com/watch?v=xb1GMZacM8w",
  "extensao-lombar": "https://www.youtube.com/watch?v=uBhiUlMAUM0",
};
