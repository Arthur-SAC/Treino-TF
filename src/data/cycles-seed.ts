...
const HYPERTROPHY: WorkoutTemplate[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: "kickback-cabo", sets: 4, repsTarget: "15 cada", restSec: 30 },
...
const REFINEMENT: WorkoutTemplate[] = [
  {
    ...
    exercises: [
      ...
      { exerciseId: "kickback-cabo", sets: 4, repsTarget: "20 cada", restSec: 30 },
      { exerciseId: "abdutor-band-em-pe", sets: 3, repsTarget: "20 cada", restSec: 30 },
    ],
  },
  {
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: "abdutor-band-em-pe", sets: 3, repsTarget: "20 cada", restSec: 30 },
      { exerciseId: "elevacao-pelvica-banco", sets: 3, repsTarget: "15 cada", restSec: 30 },
